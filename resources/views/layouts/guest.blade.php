...
<head>
    ...
    <title>BMANAGER - @yield('title', 'Home')</title>
...
<header>
    <div class="header-left">
        <div id="logo" onclick="window.location.href='{{ route('home') }}'">
            <span class="logo-icon">BM</span> BMANAGER
        </div>
        <nav>
            <ul>
                <li><a href="{{ route('home') }}" class="{{ request()->routeIs('home') ? 'active' : '' }}">Home</a></li>
                <li><a href="{{ route('home') }}#prices">Price Awareness</a></li>
...
<footer>
    <div class="footer-container">
        ...
        <div class="footer-col">
            <h4>Tools</h4>
            <div class="footer-link-group">
                <a href="{{ route('home') }}#prices">Price Awareness</a>
